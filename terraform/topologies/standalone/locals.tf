locals {
  ...
  oss_addons = {
    ...
    enable_litellm_operator  = try(var.addons.enable_litellm_operator, false)  # TODO see https://github.com/PalenaAI/litellm-operator and https://github.com/bbdsoftware/litellm-operator
    enable_langfuse          = try(var.addons.enable_langfuse, false)          # TODO
    enable_langfuse_operator = try(var.addons.enable_langfuse_operator, false) # TODO see https://langfuse-operator.palena.ai/
    enable_langtrace         = try(var.addons.enable_langtrace, false)         # TODO see https://www.langtrace.ai/
