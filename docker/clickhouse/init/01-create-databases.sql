...
CREATE DATABASE IF NOT EXISTS langtrace;
...
CREATE USER IF NOT EXISTS langtrace_user IDENTIFIED WITH plaintext_password BY 'langtrace_password';
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER ON langtrace.* TO langtrace_user;
...
GRANT CLUSTER ON *.* TO langtrace_user;
